...
foreach(split($lineseparator,$csvcontent) as $line) {
	...
	************************************/
	...
	if($addauto)
		$query = "insert into $databasetable (a_id, a_lastName, a_firstName, a_gender, a_dob, a_height, a_weight, a_cStreet, a_cCity, a_cProvince, a_cPostalCode, a_cPhone, a_pStreet, a_pCity, a_pProvince, a_pPostalCode, a_pPhone, a_program) values('','$linemysql');";
	else
		$query = "insert into $databasetable (a_id, a_lastName, a_firstName, a_gender, a_dob, a_height, a_weight, a_cStreet, a_cCity, a_cProvince, a_cPostalCode, a_cPhone, a_pStreet, a_pCity, a_pProvince, a_pPostalCode, a_pPhone, a_program) values('$linemysql');";
